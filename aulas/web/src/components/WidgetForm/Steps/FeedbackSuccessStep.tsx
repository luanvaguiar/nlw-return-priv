        ...
        <>
            ...
            <div className="flex flex-col items-center py-10 w-[304px]">
                ...
                <button
                    ...
                    className="py-2 px-6 mt-6 bg-zinc-800 rounded-md border-transparent text-sm loading-4 hover:bg-zinc-700 transition-colors focus:outline-none resize-none scrollbar scrollbar-thumb-zinc-700 scrollbar-track-transparent scrollbar-thin"
                >
                    Quero enviar ourto
                </button>
            </div>
